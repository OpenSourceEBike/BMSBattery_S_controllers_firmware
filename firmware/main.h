...
#define WHEEL_SPEED_PI_CONTROLLER_KP_DIVIDEND	128
#define WHEEL_SPEED_PI_CONTROLLER_KP_DIVISOR	6
#define WHEEL_SPEED_PI_CONTROLLER_KI_DIVIDEND	32
#define WHEEL_SPEED_PI_CONTROLLER_KI_DIVISOR	7

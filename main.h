...
#define ADC_MOTOR_CURRENT_NOMINAL 15 // 15 = 7.5A; 1 --> 0.5A
...
#define ADC_MOTOR_CURRENT_NOMINAL 25 // 25 = 12A; 1 --> 0.5A
#define ADC_MOTOR_REGEN_CURRENT_MAX 4 	// 1 --> 0.5A
#endif
...
// *************************************************************************** //
// PAS
#define PAS_NUMBER_MAGNETS 5
#define PAS_MAX_CADENCE_RPM 90
#define PAS_MIN_CADENCE_RPM 5
#define PAS_MAX_MAGNET_PULSES_PER_SECOND ((PAS_MAX_CADENCE_RPM * PAS_NUMBER_MAGNETS) / 60)

#define PAS_MAX_CADENCE_TIMER2_TICKS (1 / (PAS_MAX_CADENCE_RPM * PAS_NUMBER_MAGNETS) / 60) / 0.000128)
#define PAS_MIN_CADENCE_TIMER2_TICKS (1 / (PAS_MIN_CADENCE_RPM * PAS_NUMBER_MAGNETS) / 60) / 0.000128)

...
//  ADC1_SetLowThreshold(ADC_MOTOR_TOTAL_CURRENT_MIN_NEGATIVE << 2);

  ADC1_SetHighThreshold(360);
  ADC1_SetLowThreshold(288);

  ADC1_Cmd (ENABLE);

  ADC1_AWDChannelConfig (ADC1_CHANNEL_0, DISABLE);
  ADC1_AWDChannelConfig (ADC1_CHANNEL_1, DISABLE);
  ...
  ADC1_AWDChannelConfig (ADC1_CHANNEL_7, DISABLE);
  ADC1_AWDChannelConfig (ADC1_CHANNEL_8, DISABLE);
  ADC1_AWDChannelConfig (ADC1_CHANNEL_9, DISABLE);
  ADC1_AWDChannelConfig (ADC1_CHANNEL_12, DISABLE);

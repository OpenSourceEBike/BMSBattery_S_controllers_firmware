...
#define MOTOR_ROTOR_DELTA_PHASE_ANGLE_RIGHT 195
...
#define BLUOSEC
#define EEPROM_INIT_MAGIC_BYTE 158 // makes sure (chance of fail 1/255) eeprom is invalidated after flashing new config

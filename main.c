        ...
        if (ui8_slowloop_flag)
        {
            ...
            if (ui8_veryslowloop_counter > 5)
            {
                ...
                printf("T: %3d, S: %3d, BC: %3d, CV: %3d, PC: %3d; PC: %3d, %3d, %3d, %3d, %3d, %3d; O: %3d, %3d, %3d, %3d, %3d, %3d\r\n",
					   ...
					   uint8_t_hall_case[uint8_t_hall_debug_order[0]],
					   uint8_t_hall_case[uint8_t_hall_debug_order[1]],
					   uint8_t_hall_case[uint8_t_hall_debug_order[2]],
					   uint8_t_hall_case[uint8_t_hall_debug_order[3]],
					   uint8_t_hall_case[uint8_t_hall_debug_order[4]],
					   uint8_t_hall_case[uint8_t_hall_debug_order[5]],
